...
// POST: Iniciar sesion mediante el nombre de usuario y password
router.post('/', function (req, res, next) {
  // OPERATION
  let operation = "Iniciar sesion mediante el nombre de usuario y password"
